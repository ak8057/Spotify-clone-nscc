  ...
  return (
    <div className="track">
      <div className="track-left">
        <img
          className="banner"
          src="https://i.ytimg.com/vi/JCf7lKL1UQ4/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLCoPI8f1JEzvD78oQbi0fTAexCREw"
          alt=""
        />
        <div className="song">
